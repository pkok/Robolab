...
Ashar et al.~\cite{ashar2010robocup} presents a well tested hierarchy of modules implementing perception, world modelling and behaviour generation, incorporating a simpler self-localization system. Due to time constraints we limited ourselves to feature detection and localization.
