...
feature_extraction: /usr/local/lib/libopencv_contrib.so
feature_extraction: /usr/local/lib/libopencv_core.so
feature_extraction: /usr/local/lib/libopencv_features2d.so
feature_extraction: /usr/local/lib/libopencv_flann.so
feature_extraction: /usr/local/lib/libopencv_gpu.so
feature_extraction: /usr/local/lib/libopencv_highgui.so
feature_extraction: /usr/local/lib/libopencv_imgproc.so
feature_extraction: /usr/local/lib/libopencv_legacy.so
feature_extraction: /usr/local/lib/libopencv_ml.so
feature_extraction: /usr/local/lib/libopencv_nonfree.so
feature_extraction: /usr/local/lib/libopencv_objdetect.so
feature_extraction: /usr/local/lib/libopencv_photo.so
feature_extraction: /usr/local/lib/libopencv_stitching.so
feature_extraction: /usr/local/lib/libopencv_ts.so
feature_extraction: /usr/local/lib/libopencv_video.so
feature_extraction: /usr/local/lib/libopencv_videostab.so
