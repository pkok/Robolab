...
double *gBufferDouble = (double*)malloc(sizeof(double));
int    *gBufferInt    = (int*)malloc(sizeof(int));
/*----------------------------------------------------------------------------*/
...
int main(int argc, char **argv)
{
  ...
  EllipseDetection(image, rho, prec, p, eps, smooth, &ell_count, &circ_count, &line_count,argv[1]);
  finish = clock(); 
